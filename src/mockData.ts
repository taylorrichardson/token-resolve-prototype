...
export const initialMockData: ContentPlanNode[] = [
  ...
  },
  {
    ...
    type: 'Content Plan Item',
    status: 'Active',
    folderTemplate: '/${application_folder}/${submission_id}/m1/12-form/form-${matched_document.language__v}-${matched_document.title__v}.pdf',
    actualFileName: null,
    expectedSteadyStateCount: 1,
    matchedDocuments: [],
  },
  {
    ...
    type: 'Content Plan Item',
    status: 'Active',
    folderTemplate: '/${application_folder}/${submission_id}/m2/20-summary/summary-${matched_document.title__v}.pdf',
    actualFileName: null,
    expectedSteadyStateCount: 1,
    matchedDocuments: [],
  },
